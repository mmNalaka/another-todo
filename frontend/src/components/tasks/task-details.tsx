...
export function TaskDetails({
  ...
  return (
    <div
      className={cn(
        'flex flex-col h-full overflow-auto border-l border-gray-200 dark:border-zinc-800 bg-white dark:bg-zinc-900 w-full md:w-1/2 p-4',
        isMobile ? 'fixed inset-0 z-30' : 'w-[720px]',
      )}
    >
